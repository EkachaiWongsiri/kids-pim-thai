...
import { Globe, Info, Mail, ShieldCheck, FileText, ExternalLink, Menu, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 flex items-center justify-between h-14 md:h-16">
        ...
        <div className="hidden lg:flex items-center gap-1 text-xs font-semibold text-slate-300">
          <button
            ...
            className="flex items-center gap-1 px-3 py-1.5 rounded-lg hover:bg-slate-800 hover:text-white transition"
          >
        ...
        {/* Right: GUI Language Switcher & Mobile Menu Trigger */}
        <div className="flex items-center gap-2">
          {/* Bilingual Switcher */}
          <button
            onClick={onToggleGuiLang}
            className="flex items-center gap-1.5 px-3 py-1.5 bg-slate-900 hover:bg-slate-800 text-amber-300 border border-slate-700 hover:border-amber-400/50 rounded-xl text-xs font-bold transition shadow-sm"
